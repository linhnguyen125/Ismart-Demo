...
@section('content')
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <div class="analytic">
                    <a href="{{ request()->fullUrlWithQuery(['status' => '1']) }}" class="text-primary">Đang xử lý<span
                            class="text-muted">({{ $count[0] }})</span></a>
                    <a href="{{ request()->fullUrlWithQuery(['status' => '2']) }}" class="text-primary">Đang vận chuyển<span
                            class="text-muted">({{ $count[1] }})</span></a>
                    <a href="{{ request()->fullUrlWithQuery(['status' => '3']) }}" class="text-primary">Hoàn thành<span
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('detail_order', $item->id) }}" style="width: 30px;"
                                                ...
                                                title="<small>Chi tiết</small>"><i class="fas fa-info"></i></a>
                                            ...
                                            @else
                                                <a href="{{ route('forceDelete_order', $item->id) }}"
                                                    onclick="return confirm('Bạn có chắc chắn xóa đơn hàng này khỏi hệ thống?')"
                                                    class="btn btn-danger btn-sm rounded-0 text-white" type="button"
